      ...
      <Grid item xs={12} lg={6}>
        <Stack spacing={3}>
          ...
          <MainCard title='Caption' codeHighlight>
            <Stack spacing={1}>
              <Typography variant='caption'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</Typography>
              <Breadcrumbs aria-label='breadcrumb'>
                <Typography variant='h6'>Size: 12px</Typography>
                <Typography variant='h6'>Weight: Regular</Typography>
                <Typography variant='h6'>Line Height: 20px</Typography>
      ...
      <Grid item xs={12} lg={6}>
        <Stack spacing={3}>
          ...
          <MainCard title='Overline' codeHighlight>
            <Stack spacing={1.5}>
              <Typography variant='overline'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</Typography>
              <Breadcrumbs aria-label='breadcrumb'>
                <Typography variant='h6'>Size: 12px</Typography>
                <Typography variant='h6'>Weight: Regular</Typography>
                <Typography variant='h6'>Line Height: 20px</Typography>
